		...
		for x in range(0,len(self.chart)):
			for y in range(0,len(self.chart[x])):
				if self.chart[x][y] == "water":
					...
					if beaches == 0:
						#center
						screen.blit(image_dict["%s_center" % self.chart[x][y]], (x*resolution-20, y*resolution-20))
						...
						if self.chart[x-1][y] == "water":
							...
							screen.blit(rot_center(image_dict["%s_side" % self.chart[x][y]], 180), (x*resolution-20, y*resolution-20))
						elif self.chart[x][y-1] == "water":
							screen.blit(rot_center(image_dict["%s_side" % self.chart[x][y]], -90), (x*resolution-20, y*resolution-20))
						elif self.chart[x][y+1] == "water":
							screen.blit(rot_center(image_dict["%s_side" % self.chart[x][y]], 90), (x*resolution-20, y*resolution-20))
						...
						if (self.chart[x-1][y] == "water") and (self.chart[x][y-1] == "water"):
							...
							screen.blit(rot_center(image_dict["%s_corner" % self.chart[x][y]], 180), (x*resolution-20, y*resolution-20))
						elif (self.chart[x-1][y] == "water") and (self.chart[x][y+1] == "water"):
							screen.blit(rot_center(image_dict["%s_corner" % self.chart[x][y]], 90), (x*resolution-20, y*resolution-20))
						#bridges
							...
							screen.blit(rot_center(image_dict["%s_bridge" % self.chart[x][y]], 90), (x*resolution-20, y*resolution-20))
						...
						if self.chart[x][y+1] != "water":
							...
							screen.blit(rot_center(image_dict["%s_peninsula" % self.chart[x][y]], 180), (x*resolution-20, y*resolution-20))
						elif self.chart[x-1][y] != "water":
							screen.blit(rot_center(image_dict["%s_peninsula" % self.chart[x][y]], 270), (x*resolution-20, y*resolution-20))
					elif beaches == 4:
						#islands
